<?php
class ControllerCommonFileManagerPage extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$this->document->addStyle('view/stylesheet/filemanager_page.css');
		
		$this->load->language('common/filemanager_page');
		...
		$this->document->setTitle($this->language->get('heading_title')); 
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('common/filemanager_page', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		...
		$this->template = 'common/filemanager_page.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function create() {
		...
		if (!$this->user->hasPermission('modify', 'common/filemanager_page')) {
